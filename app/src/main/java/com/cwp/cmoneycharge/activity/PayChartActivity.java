...
public class PayChartActivity extends SlidingActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		payDAO = new PayDAO(PayChartActivity.this);
		KindDatap = new ArrayList<KindData>();
		ptypeDAO = new PtypeDAO(PayChartActivity.this);
	...
	public void initView() {
		...
		adapter = new ArrayAdapter<String>(PayChartActivity.this,
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.panytime:
				getAnyDate();
				Intent intentp = new Intent(PayChartActivity.this, PayChartActivity.class);
			...
			case R.id.example_left: // 上一个月的按键
				...
				Intent intentl = new Intent(PayChartActivity.this, PayChartActivity.class);
			...
			case R.id.example_right: // 下一个月的按键
				...
				Intent intentr = new Intent(PayChartActivity.this, PayChartActivity.class);
	...
	private void clickPop_photoViewBtn() {
		Intent intent = new Intent(PayChartActivity.this, AddPayActivity.class);// 创建Intent对象
	...
	private void clickSwitchBtn(String i) {
		Intent intent = new Intent(PayChartActivity.this, MainActivity.class);
		intent.putExtra("cwp.id", userid);
