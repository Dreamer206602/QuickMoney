...
public class IncomeDataActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		itypeDAO=new ItypeDAO(IncomeDataActivity.this);

		//设置年
		for(int i=0;i<=10;i++){
			yearlist.add(String.valueOf(defaultYear-i));
		}
		adapter=new ArrayAdapter<String>(IncomeDataActivity.this,android.R.layout.simple_spinner_item,yearlist);
	...
	protected void onStart(){
		...
		incomeDAO=new IncomeDAO(IncomeDataActivity.this);
		...
		beforet.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mSeries.clear();
				Intent intentp=new Intent(IncomeDataActivity.this,IncomeDataActivity.class);
		...
		aftert.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mSeries.clear();
				Intent intentp=new Intent(IncomeDataActivity.this,PayDataActivity.class);
				intentp.putExtra("defaulty", defaultYear);
				intentp.putExtra("default",defaultMonth);
				intentp.putExtra("cwp.id", userid);
				startActivity(intentp);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if(keyCode == KeyEvent.KEYCODE_BACK) { //监控/拦截/屏蔽返回键
			Intent intent=new Intent(IncomeDataActivity.this,MainActivity.class);
